import{ag as We,b0 as ht,ao as _a,B as xt,l as $e,am as bt,bN as gt,r as u,j as e,bH as w,bO as ft,bP as Nt,b1 as sa,b2 as jt,bQ as vt,u as yt,s as qt,Y as wt,bm as St,bz as _t,bG as At,bJ as Ct,D as Pt,bb as Tt,aX as Ft,G as It,H as Ot,aj as Lt,bM as Et,bL as zt,V as Qt}from"./index-ck4dfYOT.js";const Ze=(a={})=>({id:a.id,userId:a.userId??a.user_id,companyId:a.companyId??a.company_id,entityType:a.entityType??a.entity_type??"",name:a.name??"",columns:Array.isArray(a.columns)?a.columns:[],filters:a.filters&&typeof a.filters=="object"?a.filters:{},sort:a.sort&&typeof a.sort=="object"?a.sort:{},isDefault:!!(a.isDefault??a.is_default),isShared:!!(a.isShared??a.is_shared)}),Xe={async listCustomViews(a){const s=await We.get("/custom-views",{params:a?{entityType:a}:{}});return(Array.isArray(s==null?void 0:s.data)?s.data:[]).map(Ze)},async createCustomView(a){const s=await We.post("/custom-views",a);return Ze((s==null?void 0:s.data)||{})},async updateCustomView(a,s){const r=await We.put(`/custom-views/${encodeURIComponent(a)}`,s);return Ze((r==null?void 0:r.data)||{})},async upsertCustomViewByName(a){const s=(a==null?void 0:a.entityType)||"",r=String((a==null?void 0:a.name)||"").trim(),l=(await this.listCustomViews(s)).find(i=>String(i.name||"").trim()===r)||null;return l!=null&&l.id?this.updateCustomView(l.id,a):this.createCustomView(a)}},Ye=6,Je=8,na="crm-admin-quotation-manager-layout",Aa="quotation_layout_preferences",Ca="Admin Quotation Manager Layout",$t=5*1024*1024,Rt=["pdf","xls","xlsx"],Pa={num:"",owner:"",date:"",company:"",amount:"",status:"",project:""},He={accountNumber:"",name:"",email:"",phone:"",accountOwner:""},kt=[{value:"",label:"Select"},{value:"open",label:"Open"},{value:"approved",label:"Approved"},{value:"customer_approved",label:"Customer Approved"},{value:"customer_rejected",label:"Customer Rejected"},{value:"rejected",label:"Rejected"},{value:"cancelled",label:"Cancelled"}],Ta=[{value:"INR",label:"INR"},{value:"USD",label:"USD"},{value:"AED",label:"AED"},{value:"NZD",label:"NZ$"},{value:"CAD",label:"CAD"},{value:"SEK",label:"SEK"},{value:"SGD",label:"SGD"},{value:"AUD",label:"AUD"},{value:"JPY",label:"JPY"},{value:"EUR",label:"Euro"},{value:"GBP",label:"GBP"},{value:"QAR",label:"QAR"},{value:"SAR",label:"SAR"},{value:"OMR",label:"OMR"}],Ea=()=>new Date().toISOString().slice(0,10),Ut=(a,s)=>{const r=new Date(a||Ea());return r.setDate(r.getDate()+s),r.toISOString().slice(0,10)},ea=()=>{const a=Ea();return{selectedAccountId:"",selectedAccountLabel:"",clientAccountNumber:"",companyName:"",contactPerson:"",address:"",email:"",phone:"",accountOwner:"",quoteNumber:"",quotationDate:a,totalAmount:"",amountCurrency:"INR",totalProductTax:"",taxCurrency:"INR",quotationStatus:"",validUntilDate:Ut(a,30),quoteFile:null,quoteFileName:""}},Ne=[{key:"num",label:"Quotation Number",exportValue:a=>a.num},{key:"date",label:"Quotation Date",exportValue:a=>a.date},{key:"owner",label:"Quotation Owner",exportValue:a=>a.owner},{key:"company",label:"Company Name",exportValue:a=>a.company},{key:"project",label:"Project Name",exportValue:a=>a.project},{key:"amount",label:"Amount",exportValue:a=>a.amountLabel},{key:"status",label:"Status",exportValue:a=>a.statusLabel}],Mt=[{key:"num",label:"Quotation Number",type:"text",width:18},{key:"date",label:"Quotation Date",type:"date",align:"center",width:18},{key:"owner",label:"Quotation Owner",type:"text",width:22},{key:"company",label:"Company Name",type:"text",width:28},{key:"project",label:"Project Name",type:"text",width:28},{key:"amountLabel",label:"Amount",type:"text",width:18},{key:"statusLabel",label:"Status",type:"text",width:16}],ze=["num","owner","date","amount","status","company","project"],ca=(a=[],s="deal")=>{const r=a.filter(Boolean),l=(s==="account"?["num","owner","date","company","amount","status","project"]:["num","owner","date","amount","status","company","project"]).filter(i=>r.includes(i));return r.forEach(i=>{l.includes(i)||l.push(i)}),l},Fa=()=>{try{const a=window.localStorage.getItem(na),s=a?JSON.parse(a):null,r=Array.isArray(s==null?void 0:s.selectedFields)&&s.selectedFields.length>0?s.selectedFields.filter(o=>Ne.some(l=>l.key===o)):ze;return{selectedFields:ca(r)}}catch{return{selectedFields:ze}}},aa=(a={})=>{const s=Array.isArray(a==null?void 0:a.selectedFields)&&a.selectedFields.length>0?a.selectedFields.filter(r=>Ne.some(o=>o.key===r)):ze;return{selectedFields:ca(s.length>0?s:ze)}},A={brandKey:"swati",organizationName:"Swati Switchgears India Pvt Ltd",organizationLegalName:"Swati Switchgears (India) Pvt. Ltd.",organizationAddress:"36 Shubhlaxmi Industrial Estate, Sarkhej Bavla Road, Changodar, Ahmedabad - 382210",organizationAddressLines:["36 Shubhlaxmi Industrial Estate,","Sarkhej Bavla Road, Changodar,","Ahmedabad - 382210"],organizationEmail:"mkt@swatiswitchgears.com",organizationPhone:"9913536307",organizationGstin:"24AAACZ0615P1Z7",organizationStateCode:"24",website:"www.swatiswitchgears.com",organizationTagline:"",logoType:"image"},oa={brandKey:"lumos",organizationName:"Lumos Building Automation Pvt Ltd",organizationLegalName:"Lumos Building Automation Pvt. Ltd.",organizationAddress:"Vadodara, Gujarat, India",organizationEmail:"sales@lumosbuildingautomation.com",organizationPhone:"+91 265 4000 222",organizationGstin:"24AAECL9020K1ZY",organizationStateCode:"24",website:"www.lumosbuildingautomation.com",organizationTagline:"Building automation, controls and smart infrastructure solutions.",logoType:"image"},Ia={swati:A,"swati-switch":A,"swati-switch-gear":A,lumos:oa,"lumos-building":oa},da=[{key:"pdf",label:"View As PDF",icon:ht,iconClass:"aqp-action-icon--pdf"},{key:"preview",label:"Preview",icon:_a},{key:"view",label:"View Quote",icon:_a},{key:"approve",label:"Approve Quote",icon:xt},{key:"reject",label:"Reject Quote",icon:$e},{key:"clone",label:"Clone Quote",icon:bt},{key:"account",label:"View Account",icon:gt}],v=a=>String(a||"").trim().toLowerCase(),Oa=a=>String(a||"").split(/\r?\n|,/).map(s=>s.trim()).filter(Boolean),Dt=(a={})=>[a.address,a.location,a.state].filter(Boolean).join(", "),Vt=(a="")=>{const s=String(a||"").split(".");return s.length>1?v(s.pop()):""},La=a=>{if(!a)return"Quote File is required.";const s=Vt(a.name);return Rt.includes(s)?a.size>$t?"Quote File size must be 5 MB or less.":"":"Only PDF, XLS and XLSX files are allowed."},Re=(a={})=>{const s=v(a.profileKey);if(s&&Ia[s])return Ia[s];const r=v(a.profileName||a.organizationName);return r.includes("swati")?A:r.includes("lumos")?oa:{}},Bt=(a={})=>Re(a).brandKey==="swati",Gt=(a={})=>Re(a).brandKey==="lumos",pa=a=>a==="lumos"?Et:a==="swati"?zt:null,za=a=>a==="lumos"?"lumos":a==="swati"?"swati":"",Kt=(a={})=>{const s=Re(a);return s.logoType?s.logoType==="image":v(a.profileName||a.organizationName).includes("swati")},Qa=a=>{if(!a)return"-";const s=new Date(a);if(Number.isNaN(s.getTime()))return String(a);const r=String(s.getDate()).padStart(2,"0"),o=String(s.getMonth()+1).padStart(2,"0"),l=s.getFullYear();return`${r}-${o}-${l}`},ta=a=>{if(!a)return"-";const s=new Date(a);return Number.isNaN(s.getTime())?String(a):new Intl.DateTimeFormat("en-GB",{day:"2-digit",month:"short",year:"numeric"}).format(s)},S=a=>{const s=Number.parseFloat(a);return Number.isFinite(s)?s:0},d=a=>String(a||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),ua=a=>{const s=v(a).replace(/[\s-]+/g,"_");return s?s==="accepted"?"approved":s==="new"?"draft":s:"draft"},je=a=>{const s=ua(a),r={draft:"Draft",sent:"Sent",approved:"Approved",rejected:"Rejected",cancelled:"Cancelled",open:"Open"};return r[s]?r[s]:s.split("_").map(o=>o.charAt(0).toUpperCase()+o.slice(1)).join(" ")},$a=a=>{const s=ua(a);return s==="approved"?"aqp-status--approved":s==="rejected"?"aqp-status--rejected":s==="sent"?"aqp-status--sent":"aqp-status--open"},la=a=>{const s=ua(a);return s==="approved"||s==="cancelled"?"aqp-num-badge--orange":"aqp-num-badge--teal"},Wt=(a={})=>[a==null?void 0:a.name,a==null?void 0:a.username,a==null?void 0:a.email].map(s=>v(s)).filter(Boolean),Zt=(a,s)=>{var y,j,P,f,T;const r=v(a==null?void 0:a.role);if(r==="admin"||r==="super_admin")return da.map(F=>F.key);const l=[s==null?void 0:s.owner,(y=s==null?void 0:s.raw)==null?void 0:y.selectedAccountOwner,(j=s==null?void 0:s.raw)==null?void 0:j.ownerName,(P=s==null?void 0:s.raw)==null?void 0:P.createdBy].map(F=>v(F)),i=Wt(a),x=l.some(F=>F&&i.includes(F)),h=!!((f=a==null?void 0:a.permissions)!=null&&f.approveQuotes||(T=a==null?void 0:a.permissions)!=null&&T.approveQuotation);if(r==="viewer"||!x&&!h)return["pdf","preview","view"];const N=["pdf","preview","view","clone"];return h&&N.push("approve","reject"),N},ra=(a,s)=>{const r=new Set(Zt(a,s));return da.filter(o=>r.has(o.key))},ia=(a,s)=>{const o=Math.max(1,a-Math.floor(2.5)),l=Math.min(s,o+5-1),i=Math.max(1,l-5+1);return Array.from({length:l-i+1},(x,h)=>i+h)},Q=a=>a||"-",Xt=(...a)=>a.map(s=>String(s||"").trim()).filter(Boolean).join(", "),Ra=(a={})=>{const r=(Array.isArray(a.lineItems)?a.lineItems:[]).filter(l=>String((l==null?void 0:l.description)||"").trim()).map((l,i)=>{const x=S(l.quantity||l.qty||0),h=S(l.rate||l.price||l.unitPrice||0),N=Number.isFinite(Number(l.amount))?Number(l.amount):x*h;return{id:l.id||`line-${i+1}`,srNo:i+1,description:l.description,quantity:x,unit:l.unit||"Nos",rate:h,amount:N}});if(r.length>0)return r;const o=[a.product,a.otherProduct,a.otherService,a.projectName].filter(Boolean).join(" / ");return!o&&!S(a.amount)?[]:[{id:a.id||"line-1",srNo:1,description:o||a.companyName||"Quotation Item",quantity:1,unit:"Nos",rate:S(a.amount),amount:S(a.amount)}]},ka=a=>{const s=["","One","Two","Three","Four","Five","Six","Seven","Eight","Nine"],r=["Ten","Eleven","Twelve","Thirteen","Fourteen","Fifteen","Sixteen","Seventeen","Eighteen","Nineteen"],o=["","","Twenty","Thirty","Forty","Fifty","Sixty","Seventy","Eighty","Ninety"];return a===0?"":a<10?s[a]:a<20?r[a-10]:a<100?`${o[Math.floor(a/10)]}${a%10?` ${s[a%10]}`:""}`:`${s[Math.floor(a/100)]} Hundred${a%100?` ${ka(a%100)}`:""}`},Yt=a=>{const s=Math.floor(Math.abs(S(a)));if(!s)return"Zero";const r=[{divisor:1e7,label:"Crore"},{divisor:1e5,label:"Lakh"},{divisor:1e3,label:"Thousand"},{divisor:1,label:""}];let o=s;const l=[];return r.forEach(({divisor:i,label:x})=>{if(o>=i){const h=Math.floor(o/i);o%=i,h>0&&(l.push(ka(h)),x&&l.push(x))}}),l.join(" ").trim()},Ua=(a,s)=>{if(!a)return null;const r=s.find(i=>String(i.id)===String(a.selectedAccountId||""));if(r)return r;const o=v(a.clientAccountNumber);if(o){const i=s.find(x=>v(x.accountNumber)===o);if(i)return i}const l=v(a.companyName);if(l){const i=s.find(x=>v(x.name)===l);if(i)return i}return null},Ee=(a,s)=>{var L,pe,Y;const r=Re(a),o=r.brandKey?r:A,l=Bt(a)||!r.brandKey,i=Gt(a),x=!!r.brandKey,h=o.brandKey||(l?"swati":i?"lumos":"swati"),N=pa(h),y=Ra(a),j=y.reduce((ke,R)=>ke+S(R.amount),0),P=S(a.cgstAmount||a.cgst||0),f=S(a.sgstAmount||a.sgst||0),T=S(a.igstAmount||a.igst||0),F=S(a.taxAmount||0),ve=S(a.amount),Z=j+P+f+T+F,ie=ve>0?Math.max(ve,Z):Z,ye=a.logoType||r.logoType||(Kt(a)?"image":"text"),I=a.clientAddressDetails||Xt(s==null?void 0:s.address,s==null?void 0:s.location,s==null?void 0:s.state)||"-",$=x?o.organizationName:a.organizationName||o.organizationName||a.profileName||A.organizationName,qe=x?o.organizationLegalName||$:a.organizationLegalName||o.organizationLegalName||$,ce=x?o.organizationAddress||"":a.organizationAddress||o.organizationAddress||A.organizationAddress,X=o.organizationAddressLines||Oa(ce),we=x?o.organizationEmail||"":a.organizationEmail||o.organizationEmail||A.organizationEmail,de=x?o.organizationPhone||"":a.organizationPhone||o.organizationPhone||A.organizationPhone,Se=x?o.organizationGstin||"":a.organizationGstin||o.organizationGstin||A.organizationGstin,O=x?o.organizationStateCode||"":a.organizationStateCode||o.organizationStateCode||A.organizationStateCode;return{id:a.id,quotationNumber:a.quotationNumber||"-",quotationDate:ta(a.quotationDate||a.createdAt),validUntil:ta(a.validUntil),currency:a.currency||o.currency||"INR",statusLabel:je(a.status),profileName:a.profileName||"-",brandKey:h,brandClassName:za(h),logoSource:N,isSwatiDocument:l,isLumosDocument:i,organizationName:$,organizationLegalName:qe,organizationAddress:ce,organizationAddressLines:X,organizationEmail:we,organizationPhone:de,organizationGstin:Se,organizationStateCode:O,website:x?o.website||"":a.website||o.website||A.website,organizationTagline:a.organizationTagline||o.organizationTagline||"",logoType:ye,companyName:a.companyName||(s==null?void 0:s.name)||"-",clientAccountNumber:a.clientAccountNumber||(s==null?void 0:s.accountNumber)||"-",contactPerson:a.contactPerson||(s==null?void 0:s.contactPerson)||"-",telephone:a.telephone||(s==null?void 0:s.phone)||(s==null?void 0:s.contactPhone)||"-",email:a.email||(s==null?void 0:s.email)||(s==null?void 0:s.contactEmail)||"-",gstin:a.gstin||(s==null?void 0:s.gstin)||"-",stateCode:a.stateCode||(s==null?void 0:s.stateCode)||"-",accountOwner:(s==null?void 0:s.accountOwnerDisplay)||a.selectedAccountOwner||(s==null?void 0:s.accountOwner)||"-",customerReferenceNumber:((L=a.customerReference)==null?void 0:L.number)||"-",customerReferenceDate:ta((pe=a.customerReference)==null?void 0:pe.date),customerReferenceSubject:((Y=a.customerReference)==null?void 0:Y.subject)||"-",quotationSubject:a.quotationSubject||"-",projectName:a.projectName||"-",clientAddressDetails:I,clientAddressLines:Oa(I==="-"?"":I),product:a.product||"-",otherProduct:a.otherProduct||"-",otherService:a.otherService||"-",deliveryTerms:a.deliveryTerms||"-",paymentTerms:a.paymentTerms||"-",warrantyTerms:a.warrantyTerms||"-",quotationNotes:a.quotationNotes||"-",rejectionReason:a.rejectionReason||"",lineItems:y,subtotal:j,cgst:P,sgst:f,igst:T,otherTax:F,total:ie,amountInWords:`${Yt(ie)} ${a.currency==="USD"?"US Dollars":a.currency==="EUR"?"Euros":"Rupees"} Only`}},Jt=[{key:"srNo",label:"Sr No",type:"integer",align:"center",width:8},{key:"description",label:"Description",align:"left",width:48,wrap:!0},{key:"quantity",label:"Qty",type:"number",align:"right",width:10},{key:"unit",label:"Unit",align:"center",width:10},{key:"rate",label:"Rate",type:"currency",align:"right",width:16},{key:"amount",label:"Amount",type:"currency",align:"right",width:18}],Ht=a=>{if(!a)return null;const s=h=>{const N=String(h??"").trim();return N&&N!=="-"?N:""},r=[{label:"Quotation No.",value:s(a.quotationNumber)},{label:"Quotation Date",value:s(a.quotationDate)},{label:"Valid Until",value:s(a.validUntil)},{label:"Status",value:s(a.statusLabel)},{label:"Currency",value:s(a.currency)},{label:"Profile",value:s(a.profileName)},{label:"Customer",value:s(a.companyName)},{label:"Account No.",value:s(a.clientAccountNumber)},{label:"Contact Person",value:s(a.contactPerson)},{label:"Telephone",value:s(a.telephone)},{label:"Email",value:s(a.email)},{label:"GSTIN",value:s(a.gstin)},{label:"State Code",value:s(a.stateCode)},{label:"Account Owner",value:s(a.accountOwner)},{label:"Customer Address",value:s(a.clientAddressDetails)},{label:"Project Name",value:s(a.projectName)},{label:"Quotation Subject",value:s(a.quotationSubject)},{label:"Inquiry Ref No",value:s(a.customerReferenceNumber)},{label:"Inquiry Ref Date",value:s(a.customerReferenceDate)},{label:"Inquiry Subject",value:s(a.customerReferenceSubject)},{label:"Delivery Terms",value:s(a.deliveryTerms)},{label:"Payment Terms",value:s(a.paymentTerms)},{label:"Warranty Terms",value:s(a.warrantyTerms)},{label:"Quotation Notes",value:s(a.quotationNotes)}].filter(h=>h.value);a.rejectionReason&&r.push({label:"Rejection Reason",value:a.rejectionReason});const o=(a.lineItems||[]).map(h=>({srNo:h.srNo,description:h.description,quantity:h.quantity,unit:h.unit,rate:h.rate,amount:h.amount})),l=[],i=(h,N)=>{!Number.isFinite(Number(N))||Number(N)===0||l.push({srNo:"",description:h,quantity:"",unit:"",rate:"",amount:Number(N)})};i("Subtotal",a.subtotal),i("CGST",a.cgst),i("SGST",a.sgst),i("IGST",a.igst),i("Other Tax",a.otherTax),i("Total",a.total),a.amountInWords&&l.push({srNo:"",description:`Amount in Words: ${a.amountInWords}`,quantity:"",unit:"",rate:"",amount:""});const x=[...o,...l];return{title:`Sales Quotation - ${s(a.quotationNumber)||"Draft"}`,subtitle:s(a.companyName)||s(a.organizationName),sheetName:"Quotation",companyName:a.organizationName,metadata:r,columns:Jt,rows:x}},Ma=a=>{const s=a.logoSource||pa(a.brandKey),r=a.brandClassName||za(a.brandKey),o=a.lineItems.map(i=>`
    <tr>
  ...
  `).join(""),l=s?`<div class="logo-wrap logo-wrap--${d(r||"default")}"><img src="${s}" alt="${d(a.organizationName)}" class="logo logo--${d(r||"default")}" /></div>`:`<div class="logo-text">${d(a.organizationName)}</div>`;return`<!doctype html>
  <html>
    <head>
      <meta charset="utf-8" />
